...
class _ProductListPageState extends State<ProductListPage> {
  ...
  final List<Product> products = [
    Product(
      ...
      price: '約5,000円',
      rating: 3,
      description: '力をN(ニュートン)表示で測れて、グラム表示も可能。力学で活躍する。',
      videos: [fook],
      category: '力学',
    ),
    Product(
      ...
      price: '約2,000円',
      rating: 2,
      description: '10gから500gまで色々あり、糸を括り付けることもできる。',
      videos: [verticalSpringOscillation],
      category: '力学',
    ),
    Product(
      title: 'オシロスコープ',
    ...
    Product(
      ...
      price: '約13,000円',
      rating: 1,
      description: '磁場(磁束密度B)が測れる。スマホで測ると壊れそうな磁場でもこれで測れる。が、高校物理の実験で使うにはコスパ的に星1つ。',
      videos: [neodymiumMagnetFieldMeasurement, magneticFieldCircularLoop, solenoidMagneticField],
      category: '電磁気',
    ),
    Product(
      title: '抵抗セット',
      url: 'https://amzn.to/4ncZFbw',
      imageUrl: 'assets/goods/resistance.jpg',
      price: '約1,000円',
      rating: 3,
      description: '10Ωから1M(メガ)Ωまで色々な種類の抵抗が入っている。実験初心者におすすめ。',
      videos: [ohmsLaw, resistanceMeasurement, seriesResistance, parallelResistance],
      category: '電磁気',
    ),
    Product(
      title: 'マルチメータ(アナログ)',
      ...
      price: '約7,500円',
      rating: 2,
      description: '電流計,電圧計はもちろんのこと、実は抵抗も測ることができる。モノは良いと思うが少し高いので星2つ。',
      videos: [resistanceMeasurement, seriesResistance, parallelResistance, ohmsLaw, capacitorChargeStorage],
      category: '電磁気',
    ),
    Product(
      title: 'マルチメータ(デジタル)',
      ...
      price: '約3,300円',
      rating: 3,
      description: 'これ1つで電流,電圧,抵抗,電気容量,温度などの測定が出来る優れモノ。実験を通して電磁気学を学ぶ為に一番推したい商品。',
      videos: [],
      category: '電磁気',
    ),
    Product(
      ...
      price: '約4,000円',
      rating: 2,
      description: '電気容量,抵抗に加えて自己インダクタンスの測定ができる。',
      videos: [],
      category: '電磁気',
    ),
    Product(
    ...
    Product(
      ...
      price: '約4,000円',
      rating: 1,
      description: '分光スペクトルを見ることができる。ただ、10個もいらないので星1つ。',
      videos: [],
      category: '原子',
    ),
  ];
