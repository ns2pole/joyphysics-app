...
三次元ベクトルは縦ベクトルで表す：
\begin{align*}
\vec{r}(t)&=\begin{pmatrix}x(t)\\[4pt] y(t)\\[4pt] z(t)\end{pmatrix}\qquad
\vec{v}(t)=\vec{r}'(t)=\begin{pmatrix}x'(t)\\[4pt] y'(t)\\[4pt] z'(t)\end{pmatrix}\\[6pt]
...
任意のベクトル
$
\displaystyle \vec a=\begin{pmatrix}a_x\\[4pt] a_y\\[4pt] a_z\end{pmatrix},\quad
\displaystyle \vec b=\begin{pmatrix}b_x\\[4pt] b_y\\[4pt] b_z\end{pmatrix}
\text{に対して，}
...
$$
\begin{aligned}
\vec L &= m\bigl(\vec r(t)\times \vec v(t)\bigr)\\[7pt]
&= \begin{pmatrix}
...
\[
\begin{cases}
\displaystyle m a_x(t):=-\dfrac{GMm}{(x^2+y^2+z^2)^{3/2}}x(t)\quad\cdots(1)\\[8pt]
\displaystyle m a_y(t):=-\dfrac{GMm}{(x^2+y^2+z^2)^{3/2}}y(t)\quad\cdots(2)\\[8pt]
...
\end{aligned}　⬜︎
  ...
  <div class="theory-common-box">
    <p>命題1（外積ベクトルの直交性）
      平行でない2つのベクトル、\(\vec a=\begin{pmatrix}a_x\\[4pt]a_y\\[4pt]a_z\end{pmatrix} \neq \vec 0, \quad \vec b=\begin{pmatrix}b_x\\[4pt]b_y\\[4pt]b_z\end{pmatrix} \neq \vec 0\)
    に対して、
      \(\vec a\times\vec b=\begin{pmatrix}a_yb_z-a_zb_y\\[4pt]a_zb_x-a_xb_z\\[4pt]a_xb_y-a_yb_x\end{pmatrix}\)
  ...
  <div class="theory-common-box">
    ...
    \[
    \begin{cases}
      z(t)v_y(t) = y(t)v_z(t) &\quad\cdots(1)\\[4pt]
      x(t)v_z(t) = z(t)v_x(t) &\quad\cdots(2)\\[4pt]
    ...
    \begin{aligned}
      \ \ \ &y(t)v_x(t) = x(t)v_y(t) + y(0)v_x(0)-x(0)v_y(0) &\quad\cdots(3)\\[5pt]
      \underset{\times v_z(t)}{\Leftrightarrow}\  &y(t)v_x(t)v_z(t) = x(t)v_y(t)v_z(t) + \Bigl(y(0)v_x(0)-x(0)v_y(0)\Bigr)v_z(t)\\[5pt]
      \underset{(1),(2)\text{代入}}{\Leftrightarrow}\  &v_x(t)z(t)v_y(t) = v_y(t)z(t)v_x(t) + \Bigl(y(0)v_x(0)-x(0)v_y(0)\Bigr)v_z(t)\\[5pt]
